...
export default Factory.extend({
  ...
  foodPreferences: () =>
    faker.random.arrayElement([null, "pinda's", 'noten', 'lactose']),
  ...
  almanakSubscriptionPreference: () =>
    faker.random.arrayElement(['no_subscription', 'digital', 'physical']),
  ...
  userDetailsSharingPreference: () =>
    faker.random.arrayElement(['hidden', 'members_only', 'all_users']),
