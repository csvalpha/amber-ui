  ...
  component: {
    ...
    index: {
      ...
      stories: {
        ...
        of: 'Story of {{name}}',
        laurens1: 'Hehe! I am Laurens. In my first year as student, I joined Alpha. During the Kick-In I came in touch with the association. In the beginning, I doubted whether I wanted to join a student association, but I wanted to make new (Christian) friends in my new surroundings. I never regretted this decision. In my first year, I made many new contacts and enjoyed the activities. From studying, doing sports and drinking some beers with each other, to epic weekends in and out of the country. ',
