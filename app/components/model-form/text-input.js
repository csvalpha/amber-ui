...
export default Component.extend({
  ...
  inputValidityClass: computed('isInvalid', function() {
    return this.get('isInvalid') ? 'is-invalid' : '';
  }),
  type: 'text',
  model: null,
  label: null,
  ...
  isInvalid: computed('model.errors.[]', function() {
    return this.get(`model.errors.${this.get('property')}.length`) > 0;
  }),
  inputIdentifier: computed('property', function() {
    ...
    return `${this.get('model.constructor.modelName')}-form-${this.get('property')}`;
  }),
